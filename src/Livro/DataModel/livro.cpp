...
DataModelLivro::DataModelLivro(std::string nome, std::string autor, std::string genero, std::string registro, bool disponivel)
{
    this->nome = nome;
    this->autor = autor;
    this->genero = genero;
...
void DataModelLivro::set_atributo(std::string atributo, std::string value)
{
